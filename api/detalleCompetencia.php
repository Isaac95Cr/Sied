 ...
 */
require '../database/detalleCompetenciaData.php';

class detalleCompetencia extends Rest implements interfaceApi {
    ...
    public function all() {
        ...
        $id = $body['id'];
        $data = detalleCompetenciaData::getAllFrom($id);
    ...
    public function add() {
        ...
        $data = detalleCompetenciaData::insert($descripcion, $competencia);
        if ($data === true) {
    ...
    public function set() {
        ...
        $data = detalleCompetenciaData::update($descripcion, $id);
        if ($data === true) {
    ...
    public function del() {
        ...
        $data = detalleCompetenciaData::delete($id);
        if ($data === true) {
