 ...
 */
require '../database/empresaData.php';

class empresas extends Rest implements interfaceApi {
    ...
    public function add() {
        ...
        $nombre = $body['nombre'];
        $data = empresaData::insert($nombre);
        if ($data === true) {
    ...
    public function set() {
        ...
        $data = empresaData::update($nombre,$id);
        if ($data === true) {
